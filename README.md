...
1. Clone this repository `git clone https://github.com/DoDevJutsu/incomprehensible-personFinder-refactoring-java.git`
...
You can also find [the kata in C#](https://github.com/DoDevJutsu/incomprehensible-personFinder-refactoring-c-sharp) and [in Php](https://github.com/CodelyTV/incomprehensible-personFinder-refactoring-kata).
